...
\bigskip
\href{http://www.slideshare.net/AustralianBioinformatics/dont-correlate-proportions}{David Lovell scaring you about correlating relative data}
\end{frame}

\begin{frame}{A little background on the proposed alternative:\\ Model 2 regression}
